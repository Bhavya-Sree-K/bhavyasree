    ...
    <div className="max-w-4xl mx-auto">
      ...
      <ScrollReveal>
        <div className="glass rounded-2xl p-6 md:p-10 glow-border space-y-4 text-muted-foreground leading-relaxed">
          ...
          <p>I'm learning and working with Java, Spring Boot, React, and MySQL, focusing on understanding how frontend and backend systems connect and function together. From building basic full stack applications to understanding APIs and database design, I'm steadily improving my skills and confidence as a developer.</p>
